...
def server(host: str, port: int) -> None:
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as server_socket:
        ...
        server_socket.bind((host, port))  # connect the soct to the port
        server_socket.listen(4)  # allocate 4 simultaneously request
        ...
        while True:
            try:
                ...
                # the server wait for request from client and create socket connection to the client
                # * Fill in end (2)
