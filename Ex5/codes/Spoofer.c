...
void icmp(){
  ...
  ********************************************************/
  ...
  //  (struct icmpheader *) (buffer + sizeof(struct ipheader) +sizeof(struct icmpheader)) = "fdsfsd";
  struct data *dat = (struct data*)(buffer + sizeof(struct ipheader) +sizeof(struct icmpheader));
  dat->data = "Evil Hacker";
